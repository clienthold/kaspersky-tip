...
You can search for files using a hash. The following hashes are available for searching:
...
🌐 Host search by domain or url
********************************

**Returns**
------------

- is_safe (bool): Whether the host is safe or not.

Example of search with domain:
...
- is_safe (bool): Whether the IP is safe or not.
- status (str): The IP status.
- country_code (str): The country of the IP.
- hits_count (int): The number of hits the IP has.
- first_seen (datetime): The first time the IP was seen.

Example of search with IP:
